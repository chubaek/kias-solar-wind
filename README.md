...
현재 public validation 기준으로 고정한 72시간 예측 모델은 다음과 같습니다.
...
최근 CME catalog 기반 residual correction 실험은 causal recent-window CME
feature만 사용했습니다.
...
| Model | MAE | RMSE | CC |
|---|---:|---:|---:|
| Base only | 64.0717 | 82.0583 | 0.444030 |
| Base + CME residual correction | 71.6180 | 86.7311 | 0.443873 |

Private diagnostic, 2024–2025:

| Model | MAE | RMSE | CC |
|---|---:|---:|---:|
| Base only | 61.3793 | 85.9894 | 0.580837 |
| Base + CME residual correction | 74.7879 | 97.5147 | 0.471723 |

결론: CME residual correction은 public fixed validation에서 개선되지 않았고,
private diagnostic에서도 악화되었으므로 채택하지 않았습니다. 현재 선택된
모델은 `base_model_only`입니다.
